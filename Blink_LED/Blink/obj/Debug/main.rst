      ...
      000000 02 00 06         [24]  374 	ljmp	__sdcc_gsinit_startup
                                    375 ;--------------------------------------------------------
      ...
      00005F 02 00 03         [24]  389 	ljmp	__sdcc_program_startup
                                    390 ;--------------------------------------------------------
                                    391 ; Home
                                    392 ;--------------------------------------------------------
                                    393 	.area HOME    (CODE)
                                    394 	.area HOME    (CODE)
      000003                        395 __sdcc_program_startup:
      000003 02 00 86         [24]  396 	ljmp	_main
                                    ...
                                    404 ;------------------------------------------------------------
                           000000   405 	G$main$0$0 ==.
                           000000   406 	C$main.c$10$0_0$3 ==.
                                    407 ;	main.c:10: void main(void){
                                    408 ;	-----------------------------------------
                                    409 ;	 function main
                                    410 ;	-----------------------------------------
      000086                        411 _main:
                           ...
                           000001   418 	ar1 = 0x01
                           000000   419 	ar0 = 0x00
                           000000   420 	C$main.c$11$1_0$3 ==.
                                    421 ;	main.c:11: while (1){
      000086                        422 00102$:
                           000000   423 	C$main.c$12$2_0$4 ==.
                                    424 ;	main.c:12: BOARDLED = 0;                   // Liga o LED (nível baixo)
                                    425 ;	assignBit
      000086 C2 92            [12]  426 	clr	_P1_2
                           000002   427 	C$main.c$13$2_0$4 ==.
                                    428 ;	main.c:13: delay_ms(500);                  // Aguarda 500ms
      000088 90 01 F4         [24]  429 	mov	dptr,#0x01f4
      00008B 12 00 62         [24]  430 	lcall	_delay_ms
                           000008   431 	C$main.c$14$2_0$4 ==.
                                    432 ;	main.c:14: BOARDLED = 1;                   // Desliga o LED (nível alto)
                                    433 ;	assignBit
      00008E D2 92            [12]  434 	setb	_P1_2
                           00000A   435 	C$main.c$15$2_0$4 ==.
                                    436 ;	main.c:15: delay_ms(500);                  // Aguarda 500ms
      000090 90 01 F4         [24]  437 	mov	dptr,#0x01f4
      000093 12 00 62         [24]  438 	lcall	_delay_ms
      000096 80 EE            [24]  439 	sjmp	00102$
                           000012   440 	C$main.c$17$1_0$3 ==.
                                    441 ;	main.c:17: }
                           000012   442 	C$main.c$17$1_0$3 ==.
                           000012   443 	XG$main$0$0 ==.
      000098 22               [24]  444 	ret
                                    445 	.area CSEG    (CODE)
                                    446 	.area CONST   (CODE)
                                    447 	.area XINIT   (CODE)
